...
const NavBar = (props) => {
  ...
  return (
    <div className="flex bg-white-100 text-gray-900 rounded-lg p-1">
      <aside className="flex h-screen w-20 flex-col items-center border-r border-gray-200 bg-sky-900 rounded-lg p-20">
        <div className="flex h-20 w-20 items-center justify-center border-b border-gray-200 p-6 bg-white rounded-full m-4">
          <img src="https://amobasoftware.com/assets/isoAmoba.510ff07f.svg" />
        </div>
